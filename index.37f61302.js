 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Le extends Error{constructor(e,t,n){super(t),this.code=e,this.customData=n,this.name="FirebaseError",Object.setPrototypeOf(this,Le.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,De.prototype.create)}}class De{create(e,...t){const n=t[0]||{},r=`${this.service}/${e}`,a=this.errors[e],i=a?function(e,t){return e.replace(Ce,((e,n)=>{const r=t[n];return null!=r?String(r):`<${n}?>`}))}(a,n):"Error",o=`${this.serviceName}: ${i} (${r}).`;return new Le(r,o,n)}constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}}const Ce=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Te(e,t){if(e===t)return!0;const n=Object.keys(e),r=Object.keys(t);for(const a of n){if(!r.includes(a))return!1;const n=e[a],i=t[a];if(Ae(n)&&Ae(i)){if(!Te(n,i))return!1}else if(n!==i)return!1}for(const e of r)if(!n.includes(e))return!1;return!0}function Ae(e){return null!==e&&"object"==typeof e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const ut=new De("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","storage-open":"Error thrown when opening storage. Original error: {$originalErrorMessage}.","storage-get":"Error thrown when reading from storage. Original error: {$originalErrorMessage}.","storage-set":"Error thrown when writing to storage. Original error: {$originalErrorMessage}.","storage-delete":"Error thrown when deleting from storage. Original error: {$originalErrorMessage}."});
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ht(e,t,n){var r;let a=null!==(r=it[e])&&void 0!==r?r:e;n&&(a+=`-${n}`);const i=a.match(/\s|\//),o=t.match(/\s|\//);if(i||o){const e=[`Unable to register library "${a}" with version "${t}":`];return i&&e.push(`library name "${a}" contains illegal characters (whitespace or "/")`),i&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void at.warn(e.join(" "))}lt(new Oe(`${a}-version`,(()=>({library:a,version:t})),"VERSION"))}let pt=null;function ft(){return pt||(pt=Ye("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw ut.create("storage-open",{originalErrorMessage:e.message})}))),pt}async function gt(e,t){var n;try{const n=(await ft()).transaction("firebase-heartbeat-store","readwrite"),r=n.objectStore("firebase-heartbeat-store");return await r.put(t,mt(e)),n.done}catch(e){throw ut.create("storage-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message})}}function mt(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
ht("firebase","9.8.3","app");const wt={apiKey:"AIzaSyC3mAeoJSkVgXp7W5wSmHtE9e1wFGsySmc",authDomain:"filmoteka-209ce.firebaseapp.com",projectId:"filmoteka-209ce",storageBucket:"filmoteka-209ce.appspot.com",messagingSenderId:"68393581409",appId:"1:68393581409:web:5521fb7cea0b94cd42e320"};!function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),r=n.name;if("string"!=typeof r||!r)throw ut.create("bad-app-name",{appName:String(r)});const a=ot.get(r);if(a){if(Te(e,a.options)&&Te(n,a.config))return a;throw ut.create("duplicate-app",{appName:r})}const i=new Me(r);for(const e of st.values())i.addComponent(e);const o=new dt(e,n,i);ot.set(r,o)}(wt);function Et(e,t){return fetch(`https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=${wt.apiKey}`,{method:"POST",body:JSON.stringify({email:e,password:t,returnSecureToken:!0}),headers:{"Content-Type":"application/json"}}).then((e=>e.json())).then((e=>e.idToken))}const It=new class{create(e){return fetch("https://filmoteka-209ce-default-rtdb.firebaseio.com/films.json",{method:"POST",body:JSON.stringify(e),header:{"Content-Type":"application/json"}}).then((e=>e.json())).then((t=>(e.nameId=t.name,e))).then((e=>function(e){const t=JSON.parse(localStorage.getItem("film")||"[]");console.log(t),t.push(e),((e,t)=>{try{const n=JSON.stringify(t);localStorage.setItem(e,n)}catch(e){console.error("Set state error: ",e.message)}})("film",t)}(e)))}fetch(e){return e?fetch(`https://filmoteka-209ce-default-rtdb.firebaseio.com/films.json?auth=${e}`).then((e=>e.json())).then((e=>(console.log("films:",e),e&&e.error?`<p class="error">${e.error}</p>`:e?Object.keys(e).map((t=>({...e[t],id:t}))):[]))):Promise.resolve('<p class="error"> you don\'t have a token</p>')}},Lt=document.querySelector("#modal-btn-auth"),Dt=document.querySelector(".auth__backdrop"),Ct=document.querySelector("#js-auth__error");function Tt(e){e.preventDefault();Et(e.target.querySelector("#email").value.trim(),e.target.querySelector("#password").value.trim()).then((e=>It.fetch(e))).then(At)}function At(e){"string"==typeof e?Ct.textContent="INVALID EMAIL OR PASSWORD":(Ct.textContent="",Dt.classList.add("visually-hidden"),Lt.textContent="log out",sessionStorage.setItem("sign-in","true")),console.log(e)}function Ot(e){"Escape"===e.code&&Dt.classList.add("visually-hidden")}function Bt(e){e.target===e.currentTarget&&Dt.classList.add("visually-hidden")}Lt.addEventListener("click",(function(e){if(console.log(Lt.textContent),"log out"!==Lt.textContent){Dt.classList.remove("visually-hidden");document.querySelector(".auth__form").addEventListener("submit",Tt)}else sessionStorage.removeItem("sign-in"),Lt.textContent="sign in";window.addEventListener("keydown",Ot),Dt.addEventListener("click",Bt)}));
//# sourceMappingURL=index.37f61302.js.map
